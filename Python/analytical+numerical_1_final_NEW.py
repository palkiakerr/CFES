...
### Numerical ###
data = np.loadtxt('output_1_1mln.txt') #loads the output from the numerical solver
...
def potential(i,j):
    ...
    V_potential [np.where(r<=r0)] = 0.01
...
err_array[err_array >= 30  ] = 0 #hardcoded truncating of the error for edges
